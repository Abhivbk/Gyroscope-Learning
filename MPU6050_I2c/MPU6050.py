...
import smbus
import csv
from lib.MPUConstants import MPUConstants as C
from lib.Quaternion import Quaternion as Q
from lib.Quaternion import XYZVector as V
...
class MPU6050:
    ...
    def dmp_initialize(self):
        ...
        if self.write_prog_memory_block(C.dmpMemory, C.MPU6050_DMP_CODE_SIZE):
            ...
            if self.write_prog_dmp_configuration(C.dmpConfig,
                ...
                if self.__debug:
                    print('Setting DMP and FIFO_FLOW interrupts enabled')
    ...
    def DMP_get_euler_roll_pitch_yaw(self, a_quat, a_grav_vect):
        ...
        roll = (rad_ypr.x * (180.0/math.pi)) - 3
        pitch = (rad_ypr.y * (180.0/math.pi)) - 6
        yaw = (rad_ypr.z * (180.0/math.pi)) - (-5)
        return V(roll, pitch, yaw)
